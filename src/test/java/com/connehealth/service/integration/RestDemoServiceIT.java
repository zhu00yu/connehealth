package com.connehealth.service.integration;
...
public class RestDemoServiceIT {
    ...
    public void testGetPodcasts() throws JsonGenerationException,
        ...
        WebTarget webTarget = client
                .target("http://localhost:8888/webapi-0.0.1-SNAPSHOT/podcasts/");
    ...
    public void testGetPodcast() throws JsonGenerationException,
        ...
        WebTarget webTarget = client
                .target("http://localhost:8888/webapi-0.0.1-SNAPSHOT/podcasts/2");
